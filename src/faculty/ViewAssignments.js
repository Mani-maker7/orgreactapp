...
export default function ViewAssignments() {
  ...
  {assignment.file.endsWith('.jpg') || assignment.file.endsWith('.jpeg') || assignment.file.endsWith('.png') ? (
    <img src={`http://localhost:2527/assignmentimage/${assignment.file}`} alt="Assignment" style={{ width: '250px', height: '250px' }} />
  ) : (
    <a href={`http://localhost:2527/assignmentimage/${assignment.file}`}>Click Here</a>
  )}
</td>
